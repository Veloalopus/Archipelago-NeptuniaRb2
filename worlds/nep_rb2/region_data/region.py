...
all_dungeon_regions:List[RegionData] = [
    ...
    RegionData(atari_marsh_depths,                  1250, 1, 20,           atari_marsh  ),
    RegionData(atari_marsh,                         1250, 1, 20,           atari_marsh_depths),
    ...
    RegionData(lowee_global_expo_east,              550, 1, 10,           lowee_global_expo_west),
    RegionData(lowee_global_expo_west,              550, 1, 10,           lowee_global_expo_east),
    RegionData(midcompany,                          300, 0, 000),
    RegionData(panan_jungle,                        6300, 5, 70),
    RegionData(powerlevel_island,                   950, 1, 20),
    RegionData(rebeat_resort,                       250, 0, 000),
    RegionData(septent_resort,                      250, 0, 000),
    RegionData(severed_dimension_depths,            1550, 2, 30,           severed_dimension),
    RegionData(severed_dimension,                   1550, 2, 30,           severed_dimension_depths),
    ...
    RegionData(world_labyrinth_1st_floor,           750, 1, 20,           world_labyrinth_2nd_floor),
    RegionData(world_labyrinth_2nd_floor,           750, 1, 20,           world_labyrinth_1st_floor),
]
