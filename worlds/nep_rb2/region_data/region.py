...
all_dungeon_regions:List[RegionData] = [
    ...
    RegionData(severed_dimension_depths,            1950, 2, 30, severed_dimension, addEnemy=plan_add_enemies_severed_dimensions, changeDungeon=plan_change_dungeon_severed_dimension),
    RegionData(severed_dimension,                   1950, 2, 30, severed_dimension_depths, addEnemy=plan_add_enemies_severed_dimensions, changeDungeon=plan_change_dungeon_severed_dimension),
