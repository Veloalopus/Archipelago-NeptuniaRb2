...
all_dungeon_regions:List[RegionData] = [
    RegionData(arfoires_factory,                    1250, 2, 30),
    ...
    RegionData(graveyard_oblivion,                  2300, 5, 60),
    RegionData(hellfire_hollow,                     2360, 5, 70),
    RegionData(icicle_pathway,                      2350, 4, 60),
    RegionData(infinite_corridor,                   2350, 4, 70),
    RegionData(iris_field,                          1350, 3, 30),
    RegionData(junk_box,                            2350, 4, 60),
    RegionData(lan_castle_depths,                   1650, 3, 30,           lan_castle),
    RegionData(lan_castle_underground,              1650, 3, 30),
    RegionData(lan_castle,                          1650, 3, 30,           lan_castle_depths),
    RegionData(lost_ruins,                          2300, 5, 70),
    ...
    RegionData(panan_jungle,                        2300, 5, 70),
    RegionData(powerlevel_island,                   2300, 4, 60),
    RegionData(rebeat_resort,                       250, 0, 000),
    RegionData(septent_resort,                      250, 0, 000),
    RegionData(severed_dimension_depths,            1350, 1, 20,           severed_dimension),
    RegionData(severed_dimension,                   1350, 1, 20,           severed_dimension_depths),
    RegionData(sublie_road,                         2300, 4, 60),
    RegionData(trinity_marsh,                       2300, 5, 70),
    RegionData(underverse_depths,                   450, 1, 20,           underverse),
    RegionData(underverse,                          450, 1, 20,           underverse_depths),
